        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idProdFK = table.Column<int>(type: "int", nullable: false),
                    idStockFK = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_stockEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_stockEntries_StockProduits_idProdFK_idStockFK",
                        columns: x => new { x.idProdFK, x.idStockFK },
                        principalTable: "StockProduits",
                        principalColumns: new[] { "IdProduit", "IdStock" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stockEntries_idProdFK_idStockFK",
                table: "stockEntries",
                columns: new[] { "idProdFK", "idStockFK" });
