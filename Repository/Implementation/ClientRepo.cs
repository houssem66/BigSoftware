...
namespace Repository.Implementation
{
    public class ClientRepo : IClientRepo
    {
        ...
        public ClientRepo(BigSoftContext _bigSoftContext, IGenericRepository<Client> _genericRepository, UserManager<Utilisateur> _userManager, RoleManager<IdentityRole> _roleManager, IOptions<JWT> jwt)
        {
        ...
        public async Task<AuthModel> RegisterAsync(RegisterModelClient model)
        {
            //Testing for Email
