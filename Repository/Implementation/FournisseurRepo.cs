...
namespace Repository.Implementation
{
    public class FournisseurRepo:IFournisseurRepo
    {
        ...
        public FournisseurRepo(BigSoftContext _bigSoftContext, IGenericRepository<Fournisseur> _genericRepository, UserManager<Utilisateur> _userManager, RoleManager<IdentityRole> _roleManager, IOptions<JWT> jwt)
        {
        ...
        public async Task<AuthModel> RegisterAsync(RegisterModelFournisseur model)
        {
            //Testing for Email
            ...
            var user = new Fournisseur
            {
                ...
                Rib = model.Rib,
                PersAContact = model.Nom + " " + model.Prenom,
            ...
            {
                await userManager.AddToRoleAsync(user, "Fournisseur");
            }
            else
            {
            ...
            return new AuthModel
            {
                ...
                Roles = new List<string> { "Fournisseur" },
